                                ...
                                {trashedUsers.map((user, index) => (
                                    <tr key={user.id} className="border-b dark:border-neutral-500">
                                        ...
                                        <td className="whitespace-nowrap px-6 py-4 flex space-x-2">
                                            <button onClick={() => restoreUser(user.id)} type="button" className="px-4 py-2 bg-green-500 hover:bg-green-600 rounded-lg font-bold text-white flex items-center">
                                                <FontAwesomeIcon icon={faTrashRestore} className="mr-1" /> Restore
                                            </button>
                                            <button onClick={() => deleteUserPermanently(user.id)} type="button" className="px-4 py-2 bg-red-500 hover:bg-red-600 rounded-lg font-bold text-white flex items-center">
